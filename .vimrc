...
" PYTHON MAPPINGS
autocmd FileType python nnoremap <Leader>l :w<CR>:!python %<CR>
autocmd FileType python nnoremap <Leader>r :w<CR>:!python -i %<CR>
autocmd FileType python setlocal expandtab

" TEX MAPPINGS
" autocmd FileType tex packadd latexlivepreview
" autocmd FileType tex packadd closeb
autocmd FileType tex nnoremap <Leader>l :LLPStartPreview<CR>
autocmd FileType tex nnoremap <Leader>r :w<CR>:!xelatex %<CR>
...
autocmd FileType tex inoremap @CI \begin{compactitem}<CR>\end{compactitem}<Esc>ko<Tab>\item<CR><Tab>
...
autocmd FileType tex inoremap @Q Q.E.D.
